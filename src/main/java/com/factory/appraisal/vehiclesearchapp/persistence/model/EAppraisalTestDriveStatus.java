...
public class EAppraisalTestDriveStatus extends TransactionEntity {
    ...
    @GeneratedValue(strategy= GenerationType.TABLE,generator = "test_drive")
    @GenericGenerator(
            name = "test_drive",
    ...
    @OneToOne(targetEntity = EAppraisalVehicle.class, fetch = FetchType.LAZY)
    @JoinColumn(name = "APPRAISAL_REF ",referencedColumnName = "APPR_REF_ID",nullable = false)
    private EAppraisalVehicle appraisalRef;

    @Audited(targetAuditMode = RelationTargetAuditMode.NOT_AUDITED)
    @OneToOne(mappedBy = "appraisalTestDriveStatus")
    private EAppraisalVehicleAcCondition eAppraisalVehicleAcCondition;

    @Audited(targetAuditMode = RelationTargetAuditMode.NOT_AUDITED)
    @OneToOne(mappedBy = "appraisalTestDriveStatus")
    private EAppraisalVehicleTireCondition eAppraisalVehicleTireCondition;
