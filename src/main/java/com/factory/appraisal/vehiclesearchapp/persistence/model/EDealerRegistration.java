...
public class EDealerRegistration extends TransactionEntity {
    ...
    @GeneratedValue(strategy= GenerationType.TABLE,generator = "dealer_registration")
    @GenericGenerator(
    ...
    @Audited(targetAuditMode = RelationTargetAuditMode.NOT_AUDITED)
    @OneToOne(mappedBy = "dealerRegistration")
    private EUserRegistration eUserRegistration;
    @Audited(targetAuditMode = RelationTargetAuditMode.NOT_AUDITED)
    @OneToOne(mappedBy = "dealerRegistration")
